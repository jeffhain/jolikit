...
public class NonPremulArgbHelper implements InterfaceColorTypeHelper {
    
    //--------------------------------------------------------------------------
    // FIELDS
    //--------------------------------------------------------------------------
    
    private static final NonPremulArgbHelper INSTANCE = new NonPremulArgbHelper();
    
    //--------------------------------------------------------------------------
    // PUBLIC METHODS
    //--------------------------------------------------------------------------
    
    public static NonPremulArgbHelper getInstance() {
        return INSTANCE;
    }
    ...
    public int asPremul32FromType(int color32) {
        return BindingColorUtils.toPremulAxyz32(color32);
    }
    
    @Override
    public int asTypeFromNonPremul32(int nonPremulColor32) {
        return nonPremulColor32;
    }
    
    @Override
    public int asTypeFromPremul32(int premulColor32) {
        return BindingColorUtils.toNonPremulAxyz32(premulColor32);
    }
