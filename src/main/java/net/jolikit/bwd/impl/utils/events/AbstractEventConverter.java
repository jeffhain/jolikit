...
public abstract class AbstractEventConverter {
    ...
    public BwdMouseEvent newMousePressedEventElseNull(Object backingEvent) {
        return this.newMouseEventElseNull(
                backingEvent,
                BwdEventType.MOUSE_PRESSED);
    }
    
    public BwdMouseEvent newMouseReleasedEventElseNull(Object backingEvent) {
        return this.newMouseEventElseNull(
                backingEvent,
                BwdEventType.MOUSE_RELEASED);
    }
    
    public BwdMouseEvent newMouseEnteredClientEventElseNull(Object backingEvent) {
        return this.newMouseEventElseNull(
                backingEvent,
                BwdEventType.MOUSE_ENTERED_CLIENT);
    }
    
    public BwdMouseEvent newMouseExitedClientEventElseNull(Object backingEvent) {
        return this.newMouseEventElseNull(
                backingEvent,
                BwdEventType.MOUSE_EXITED_CLIENT);
    }
    
    public BwdMouseEvent newMouseMovedEventElseNull(Object backingEvent) {
        return this.newMouseEventElseNull(
                backingEvent,
    ...
    public BwdWheelEvent newWheelEventElseNull(Object backingEvent) {
        ...
        final BwdWheelEvent ret;
        if (scaledClientBoundsInBd.isEmpty()) {
            ret = null;
        } else {
     ...
     */
    private BwdMouseEvent newMouseEventElseNull(
            Object backingEvent,
        ...
        final BwdMouseEvent ret;
        if (scaledClientBoundsInBd.isEmpty()) {
            ret = null;
        } else {
            ret = new BwdMouseEvent(
                this.host,
                eventType,
                posInScreenInBd,
                scaledClientBoundsInBd,
