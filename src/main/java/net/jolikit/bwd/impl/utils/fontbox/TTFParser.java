...
public class TTFParser
{
    ...
    private void parseTables(TrueTypeFont font, TTFDataStream raf) throws IOException
    {
        ...
        /*
         * TODO fontbox Disabling this check, so that we can do best effort
         * (compute at least font kind) for corrupted font files
         * (like some FreeMono.otf).
         */
        if (false && !isPostScript)
        {
