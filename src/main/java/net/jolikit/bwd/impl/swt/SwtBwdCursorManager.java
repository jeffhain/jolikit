...
public class SwtBwdCursorManager extends AbstractBwdCursorManager {
    ...
    public SwtCursorRepository getBackingCursorRepository() {
    ...
    protected void setCursor(Object component, int cursor) {
        final Cursor backingCursor = this.backingCursorRepository.convertToBackingCursor(cursor);
        final Control control = (Control) component;
        control.setCursor(backingCursor);
    }
}
