 ...
 */
public abstract class AbstractAwtBwdBinding extends AbstractBwdBinding {

    //--------------------------------------------------------------------------
    // FIELDS
    //--------------------------------------------------------------------------
    
    private static final AtomicReference<AbstractBwdBinding> SINGLE_INSTANCE_REF = null;
    ...
    public AbstractAwtBwdBinding(AwtBwdBindingConfig bindingConfig) {
