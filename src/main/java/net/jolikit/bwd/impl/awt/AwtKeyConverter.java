...
public class AwtKeyConverter extends AbstractKeyConverter<Integer> {

    //--------------------------------------------------------------------------
    // PUBLIC METHODS
    //--------------------------------------------------------------------------
    
    public AwtKeyConverter() {
        
        mapTo(BwdKeys.NO_STATEMENT, KeyEvent.VK_UNDEFINED);
        ...
        //
        mapTo(BwdKeys.LEFT, KeyEvent.VK_LEFT, KeyEvent.VK_KP_LEFT);
        mapTo(BwdKeys.UP, KeyEvent.VK_UP, KeyEvent.VK_KP_UP);
        mapTo(BwdKeys.RIGHT, KeyEvent.VK_RIGHT, KeyEvent.VK_KP_RIGHT);
        mapTo(BwdKeys.DOWN, KeyEvent.VK_DOWN, KeyEvent.VK_KP_DOWN);
        //
        mapTo(BwdKeys.INSERT, KeyEvent.VK_INSERT);
        mapTo(BwdKeys.DELETE, KeyEvent.VK_DELETE);
        //
        /*
         * TODO awt AWT uses VK_CLEAR when we hit CENTER,
         * and not VK_BEGIN which I thought was designed for that.
         */
        ...
        mapTo(BwdKeys.LEFT_BRACE, KeyEvent.VK_BRACELEFT);
        mapTo(BwdKeys.RIGHT_BRACE, KeyEvent.VK_BRACERIGHT);
        ...
        mapTo(BwdKeys.TILDE, KeyEvent.VK_DEAD_TILDE);
        
        /*
         * 
         */
        
        mapUnmappedBackingKeys(AwtKeys.keyList());
    }
}
