...
public class JfxBwdFont extends AbstractBwdFont<Font> implements Comparable<JfxBwdFont> {
    ...
    public JfxBwdFont(
        ...
        this.metrics = new JfxBwdFontMetrics(
                backingFont,
                mustUseInternalApiForFontMetrics);
    }
    
    @Override
    public int compareTo(JfxBwdFont other) {
