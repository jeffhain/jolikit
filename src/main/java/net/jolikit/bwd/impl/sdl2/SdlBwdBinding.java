...
java.lang.Error: Invalid memory access
    ...
    at net.jolikit.bwd.impl.utils.AbstractIntArrayBwdGraphics.drawText(AbstractIntArrayBwdGraphics.java:219)
    at net.jolikit.bwd.test.cases.ParallelDrawingWdTestCase.drawInBox_inInitFinish(ParallelDrawingWdTestCase.java:322)
    at net.jolikit.bwd.test.cases.ParallelDrawingWdTestCase.access$0(ParallelDrawingWdTestCase.java:262)
    at net.jolikit.bwd.test.cases.ParallelDrawingWdTestCase$MySplittable.run(ParallelDrawingWdTestCase.java:138)
    at net.jolikit.threading.prl.ExecutorParallelizer$MySPTask.run(ExecutorParallelizer.java:145)
    at net.jolikit.threading.prl.ExecutorParallelizer$MyShotHandler.forkRunMergeAnyTask(ExecutorParallelizer.java:421)
    at net.jolikit.threading.prl.ExecutorParallelizer.execute(ExecutorParallelizer.java:550)
         */
        return false;
    }
