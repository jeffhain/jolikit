...
/**
 * Keys defined in JOGL/NEWT.
 * 
 * @see #com.jogamp.newt.event.KeyEvent
 */
public class JoglNewtKeys {

    //--------------------------------------------------------------------------
    // FIELDS
    //--------------------------------------------------------------------------
    
    private static final List<Short> KEY_LIST = Collections.unmodifiableList(newKeyList());
    ...
    /**
     * @return An unmodifiable list of all keys defined in JOGL/NEWT.
     */
    public static List<Short> keyList() {
        return KEY_LIST;
    }
    ...
    private JoglNewtKeys() {
    }
    
    private static List<Short> newKeyList() {
        final List<Short> list = new ArrayList<Short>();
        list.add(KeyEvent.VK_UNDEFINED);
        ...
        list.add(KeyEvent.VK_QUESTIONMARK);
        ...
        list.add(KeyEvent.VK_LEFT_BRACE);
        list.add(KeyEvent.VK_PIPE);
        list.add(KeyEvent.VK_RIGHT_BRACE);
        list.add(KeyEvent.VK_TILDE);
        ...
        list.add(KeyEvent.VK_KEYBOARD_INVISIBLE);
        return list;
    }
}
