...
public class SrdBoxsampledTest extends AbstractSrdTezt {
    
    //--------------------------------------------------------------------------
    // FIELDS
    //--------------------------------------------------------------------------
    
    private static final SrdBoxsampled TESTED_SRD_BOX_BICU = new SrdBoxsampled();
    
    /**
     * Our bilinear must accurate than AWT one.
     */
    private static final SrdBilinear REF_SRD_BILI = new SrdBilinear();
    
    //--------------------------------------------------------------------------
    // PUBLIC METHODS
    //--------------------------------------------------------------------------
    
    public SrdBoxsampledTest() {
    }
