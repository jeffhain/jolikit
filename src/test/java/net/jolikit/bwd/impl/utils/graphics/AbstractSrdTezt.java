...
/**
 * Abstract class for testing InterfaceScaledRectDrawer implementations
 * individually, eventually using another brand of implementation as reference.
 */
abstract class AbstractSrdTezt extends TestCase {
    ...
    protected static final boolean MUST_PRINT_IMAGE_ON_ERROR =
    ...
    /**
     * Use zero to make cases simpler.
     */
    private static final int OFFSET_FACTOR = 1;
    ...
    static {
        ...
        for (boolean premul : new boolean[] {false,true}) {
            list.add(SrdTestUtils.getColorTypeHelper(premul));
        }
    ...
    implements InterfaceRowDrawer {
        ...
        public String toString() {
            return SrdTestUtils.toStringPixels(this.getPixels());
        }
        @Override
        public int hashCode() {
    ...
    protected static final InterfaceParallelizer PRLZR =
        BindingPrlUtils.newParallelizer(
            ...
            PARALLELISM,
            AbstractSrdTezt.class.getClass().getSimpleName());
    
    //--------------------------------------------------------------------------
    // PUBLIC METHODS
    //--------------------------------------------------------------------------
    
    public AbstractSrdTezt() {
    }
    ...
    public void test_drawRectScaled_identity_shifted() {
        ...
        input.setPixels(new int[][] {
            ...
            {0, 0xFF001000, 0xFF000100, 0xFF000001, 0},
            {0, 0, 0, 0, 0},
        }, scanlineStride = 7);
        ...
        expected.setPixels(new int[][] {
            ...
            {0xFF001000, 0xFF000100, 0xFF000001},
        }, scanlineStride = 8);
    ...
    public void test_drawRectScaled_sturdiness_xxx(
        ...
        final int minDstPos = -3 * OFFSET_FACTOR;
        final int minPos = -2 * OFFSET_FACTOR;
        final int maxPos = 3 * OFFSET_FACTOR;
    ...
    protected static void checkMeanColorPreserved(
        ...
        final int srcMeanColor32 =
            SrdTestUtils.computeMeanColor32(
                colorTypeHelper,
                input,
                srcRect);
