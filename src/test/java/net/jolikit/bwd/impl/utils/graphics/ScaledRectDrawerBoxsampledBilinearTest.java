...
public class ScaledRectDrawerBoxsampledBilinearTest extends AbstractScaledRectDrawerTezt {
    ...
    public ScaledRectDrawerBoxsampledBilinearTest() {
    }
    ...
    protected void drawScaledRect(
        ...
        ScaledRectDrawing.drawScaledRect(
            parallelizer,
            BwdScalingType.BOXSAMPLED_BILINEAR,
            colorTypeHelper,
            //
            srcPixels,
            srcRect,
