...
public class ScaledRectDrawersPerf {
    ...
    private static final boolean MUST_BENCH_ITER_BILI = true;
    private static final boolean MUST_BENCH_ITER_BICU = true;
    private static final boolean MUST_BENCH_ITER_BILI_BICU = true;
    private static final boolean MUST_BENCH_BOX_BICU = true;
    ...
    private static final InterfaceParallelizer PRLZR =
        BindingPrlUtils.newParallelizer(
            ...
            PARALLELISM,
            ScaledRectDrawersPerf.class.getClass().getSimpleName());

    //--------------------------------------------------------------------------
    // CONSTRUCTORS
    //--------------------------------------------------------------------------
    
    public ScaledRectDrawersPerf() {
    }
    ...
    private void run() {
        ...
        System.out.println("--- " + ScaledRectDrawersPerf.class.getSimpleName() + "... ---");
    ...
    private void bench_drawRectScaled(
        ...
        if (MUST_BENCH_NEAREST) {
            drawerList.add(new SrdNearest());
        }
        if (MUST_BENCH_BOXSAMPLED) {
            drawerList.add(new SrdBoxsampled());
        }
        if (MUST_BENCH_ITER_BILI) {
            drawerList.add(new SrdIterBili());
        }
        if (MUST_BENCH_ITER_BICU) {
            drawerList.add(new SrdIterBicu());
        }
        if (MUST_BENCH_ITER_BILI_BICU) {
            drawerList.add(new SrdIterBiliBicu());
        }
        if (MUST_BENCH_BOX_BICU) {
            drawerList.add(new SrdBoxBicu());
        }
