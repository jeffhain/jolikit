...
/**
 * ScaledRectAlgoBilinear is mostly tested through ScaledRectDrawerBilinearTest,
...
public class ScaledRectAlgoBilinearTest extends TestCase {
    ...
    public void test_computeBilinearColor32_4x4_generalCase_xxx(
        ...
        for (int i = 0; i < nbrOfCalls; i++) {
            ...
            final int expected =
                ScaledRectAlgoBoxsampledTest.call_boxsampledInterpolate_general(
                    colorTypeHelper,
                    //
                    srcPixels,
                    srcRect,
    ...
    private static int call_bilinearInterpolate(
        ...
        return ScaledRectAlgoBilinear.bilinearInterpolate(
            colorTypeHelper,
            //
            srcPixels,
            srcRect,
