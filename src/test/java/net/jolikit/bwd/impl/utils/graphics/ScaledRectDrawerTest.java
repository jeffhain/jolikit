...
public class ScaledRectDrawerTest extends TestCase {
    ...
    public void test_isExactWithClosest_4int() {
        ...
        for (int i = 0; i < 1000; i++) {
            ...
            assertTrue(ScaledRectDrawer.isExactWithClosest(
                sxSpan, sySpan,
                dxSpan, dySpan));
        }
        
        assertTrue(ScaledRectDrawer.isExactWithClosest(1, 0, 1, 0));
        assertTrue(ScaledRectDrawer.isExactWithClosest(1, 1, 1, 0));
        //
        assertTrue(ScaledRectDrawer.isExactWithClosest(0, 1, 0, 1));
        assertTrue(ScaledRectDrawer.isExactWithClosest(1, 1, 0, 1));
        
        assertFalse(ScaledRectDrawer.isExactWithClosest(1, 0, 1, 1));
        assertFalse(ScaledRectDrawer.isExactWithClosest(1, 2, 1, 1));
        assertFalse(ScaledRectDrawer.isExactWithClosest(1, 3, 1, 1));
        assertFalse(ScaledRectDrawer.isExactWithClosest(1, 4, 1, 1));
        assertFalse(ScaledRectDrawer.isExactWithClosest(1, 4, 1, 2));
        assertFalse(ScaledRectDrawer.isExactWithClosest(1, 4, 1, 3));
        //
        assertFalse(ScaledRectDrawer.isExactWithClosest(0, 1, 1, 1));
        assertFalse(ScaledRectDrawer.isExactWithClosest(2, 1, 1, 1));
        assertFalse(ScaledRectDrawer.isExactWithClosest(3, 1, 1, 1));
        assertFalse(ScaledRectDrawer.isExactWithClosest(4, 1, 1, 1));
        assertFalse(ScaledRectDrawer.isExactWithClosest(4, 1, 2, 1));
        assertFalse(ScaledRectDrawer.isExactWithClosest(4, 1, 3, 1));
    }
