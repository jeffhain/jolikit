...
import net.jolikit.bwd.impl.jogl.JoglBwdBinding;
import net.jolikit.bwd.impl.jogl.JoglBwdBindingConfig;
...
/**
 * Main to launch test cases with JOGL.
 */
public class JoglBoundBwdMain implements InterfaceBindingMainLaunchInfo {

    //--------------------------------------------------------------------------
    // CONFIGURATION
    //--------------------------------------------------------------------------
    
    protected static final String BINDING_NAME = "JOGL";

    //--------------------------------------------------------------------------
    // PUBLIC METHODS
    //--------------------------------------------------------------------------

    public JoglBoundBwdMain() {
    }
    ...
    public List<String> getSpecificClasspathList() {
        return JlkBinConfig.getSpecificClasspathListForJogl();
    }

    @Override
    public String getSpecificJvmArgs() {
        return JlkBinConfig.getSpecificJvmArgsForJogl();
    }
    ...
    public static void main(String[] args) {
        if (BwdMainLaunchUtils.mustRunInThisJvm(args)) {
            ...
            final InterfaceMainLaunchInfo mainLaunchInfo = new JoglBoundBwdMain();
    ...
    protected static void launchTheBindingWithTestCaseFromArgs(
        ...
        final JoglBwdBindingConfig bindingConfig;
        {
            bindingConfig = new JoglBwdBindingConfig(
        ...
        binding.waitUntilShutdownUninterruptibly();
    }
}
