...
public class NumbersUtilsTest extends TestCase {
    ...
    public void test_asByte_short() {
        ...
        for (short value : goodArr) {
            assertEquals(value, NumbersUtils.asByte(value));
        }
    }
    ...
    public void test_asShort_int() {
        ...
        for (int value : goodArr) {
            assertEquals(value, NumbersUtils.asShort(value));
        }
    }
    ...
    public void test_asInt_long() {
        ...
        for (long value : goodArr) {
            assertEquals(value, NumbersUtils.asInt(value));
        }
    }
    ...
    public void test_toByte_short() {
        ...
        for (short value : valueArr) {
            ...
            assertEquals(expected, NumbersUtils.toByte(value));
        }
    }
    ...
    public void test_toShort_int() {
        ...
        for (int value : valueArr) {
            ...
            assertEquals(expected, NumbersUtils.toShort(value));
        }
    }
    ...
    public void test_toInt_long() {
        ...
        for (long value : valueArr) {
            ...
            assertEquals(expected, NumbersUtils.toInt(value));
        }
    }
    ...
    public void test_round_float() {
        for (int i = 0; i < NBR_OF_VALUES_SMALL; i++) {
            ...
            int res = NumbersUtils.round(value);
            boolean ok = (ref == res);
            if (!ok) {
                printCallerName();
    ...
    public void test_round_double() {
        for (int i = 0; i < NBR_OF_VALUES_SMALL; i++) {
            ...
            long res = NumbersUtils.round(value);
            boolean ok = (ref == res);
            if (!ok) {
                printCallerName();
                System.out.println("value = " + value);
    ...
    public void test_roundEven_float() {
        for (int i = 0; i < NBR_OF_VALUES_SMALL; i++) {
            ...
            int res = NumbersUtils.roundEven(value);
            boolean ok = (ref == res);
            if (!ok) {
                printCallerName();
                System.out.println("value = " + value);
    ...
    public void test_roundEven_double() {
        for (int i = 0; i < NBR_OF_VALUES_SMALL; i++) {
            ...
            long res = NumbersUtils.roundEven(value);
            boolean ok = (ref == res);
            if (!ok) {
                printCallerName();
                System.out.println("value = " + value);
    ...
    public void test_floorToInt_double() {
        for (int i = 0; i < NBR_OF_VALUES_SMALL; i++) {
            ...
            int res = NumbersUtils.floorToInt(value);
    ...
    public void test_ceilToInt_double() {
        for (int i = 0; i < NBR_OF_VALUES_SMALL; i++) {
            ...
            int res = NumbersUtils.ceilToInt(value);
            assertEquals(ref, res);
        }
    }
    ...
    public void test_roundToInt_double() {
        for (int i = 0; i < NBR_OF_VALUES_SMALL; i++) {
            ...
            int ref = (int)(double)NumbersUtils.round(value);
            int res = NumbersUtils.roundToInt(value);
            boolean ok = (ref == res);
            if (!ok) {
                printCallerName();
                System.out.println("value = " + value);
    ...
    public void test_roundEvenToInt_double() {
        for (int i = 0; i < NBR_OF_VALUES_SMALL; i++) {
            ...
            int ref = NumbersUtils.toInt(NumbersUtils.roundEven(value));
            int res = NumbersUtils.roundEvenToInt(value);
            boolean ok = (ref == res);
            if (!ok) {
                printCallerName();
                System.out.println("value = " + value);
    ...
    public void test_toString_3int() {
        ...
        assertEquals("0", NumbersUtils.toString(0, 16, 0));
        assertEquals("0F", NumbersUtils.toString(0xF, 16, 2));
        assertEquals("-000FF", NumbersUtils.toString(-0xFF, 16, 5));
        ...
        for (int value : new int[]{
            ...
            for (int radix = Character.MIN_RADIX; radix <= Character.MAX_RADIX; radix++) {
                for (int paddingUpTo : PADDING_UP_TO_ARR) {
                    ...
                    final String actual = NumbersUtils.toString(value, radix, paddingUpTo);
    ...
    public void test_toString_long_2int() {
        ...
        assertEquals("0", NumbersUtils.toString(0L, 16, 0));
        assertEquals("0F", NumbersUtils.toString(0xFL, 16, 2));
        assertEquals("-000FF", NumbersUtils.toString(-0xFFL, 16, 5));
    ...
    static String ref_toString(int value, int radix, int paddingUpTo) {
        ...
        str = NumbersUtils.leftPaddedWithZero(str, paddingUpTo);
        return str;
    }
